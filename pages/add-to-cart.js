...
export class AddToCartPage {
  ...
  async fillUserDetail(firstName, lastName, postCode) {
    await this.page.waitForTimeout(2000);
    await (
      await helper.getLocator(this.page, this.firstNameElement)
    ).fill(firstName);
    await (
      await helper.getLocator(this.page, this.lastNameElement)
    ).fill(lastName);
    await (
      await helper.getLocator(this.page, this.postCodeElement)
    ).fill(postCode);
  }
